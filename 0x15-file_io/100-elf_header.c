 ...
 * @e_ident: is a  pointer to an array containing the ELF magic numbers.
 *
 ...
 * @e_ident: is the pointer to an array containing the ELF magic numbers.
 *
...
/**
 * print_class - the function prints the class of an ELF header.
 * @e_ident: is the pointer to an array containing the ELF class.
 */
void print_class(unsigned char *e_ident)
{
printf(" Class: ");
...
/**
 * print_data - the function prints the data of an ELF header.
...
/**
 * print_osabi - the function prints the OS/ABI of an ELF header.
 * @e_ident: is a pointer to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
...
/**
 * close_elf - the function closes an ELF file.
